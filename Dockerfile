...
CMD /opt/mule/bin/mule -M-DrunEnv=prod -M-DsekoLocation=33 -M-Delk=N -M-Dspring.profiles.active=dummy -D-Mlog.threshold.console=INFO -D-Mlog.threshold.filelog=INFO
